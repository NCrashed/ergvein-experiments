...
class ErgIcon extends StatelessWidget {
  /// Creates an icon.
  ///
  ...
  /// 24.0.
  ///
  /// If this [ErgIcon] is being placed inside an [IconButton], then use
  ...
  /// [IconTheme] to pass down the size to the [ErgIcon].
  final double? size;
  ...
  /// set to true, and the [ErgIcon] widget uses the [textDirection] to determine
